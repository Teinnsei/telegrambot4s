...
import io.teinnsei.telegrambot4s.message.games.document.Game
import io.teinnsei.telegrambot4s.message.passport.document.PassportData
import io.teinnsei.telegrambot4s.message.payment.document.{Invoice, SuccessfulPayment}
import io.teinnsei.telegrambot4s.message.{ChatId, TelegramDocument}
